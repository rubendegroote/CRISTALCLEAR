...
class ExtendedVoigt(Profile):
    ...
    def setParams(self):
        ...
        if self._changeNorm:
            self._normFactor = (1 - self.nL - self.nI
                                - self.nH) * self.G._normFactor
            self._normFactor += self.nL * self.L._normFactor
            self._normFactor += self.nI * self.I._normFactor
            self._normFactor += self.nH * self.H._normFactor
